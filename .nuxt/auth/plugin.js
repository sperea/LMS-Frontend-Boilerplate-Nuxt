...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"token/login/","method":"post","propertyName":"auth_token"},"logout":{"url":"token/logout/","method":"post"},"user":{"url":"accounts/data/","method":"get","propertyName":false}},"tokenType":"Token","tokenName":"Authorization","_name":"local"}))
