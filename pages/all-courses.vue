...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mt-12 mb-12">
        <article>
            <h2 class="text-2xl font-extrabold text-gray-900">Todos los cursos</h2>
...
import Vue from "vue";
import CourseItem from "~/components/CoursesList/CourseItem.vue";
...
export default Vue.extend({
  ...
  async fetch() {
    await this.$axios
        .$get('courses/all-courses/', {'Authorization': this.$store.state.auth.token})
        .then((response) => {
